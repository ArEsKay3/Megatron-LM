...
def _add_rl_args(parser):
    ...
    group.add_argument('--grpo-branch-frequency', type=int, default=None,
                       help="Branching sampling: fork the generation every N tokens. "
                            "Combined with --grpo-branch-factor, all outputs from one prompt form a GRPO group.")
    group.add_argument('--grpo-branch-factor', type=int, default=None,
                       help="Branching sampling: number of independent continuations to spawn at each branch point.")
